...
class MAPPO(object):
    ...
    def __init__(self, env, state_dim, action_dim, n_agents, action_lower_bound, action_higher_bound, noise=0, tau=300, memory_capacity=10, max_steps=None, roll_out_n_steps=10, target_tau=1.0, target_update_steps=5, clip_param=0.2, reward_gamma=0.99, reward_scale=1.0, actor_output_act=nn.functional.softmax, critic_loss='mse', actor_lr=0.01, critic_lr=0.01, optimizer_type='adam', entropy_reg=0.0, max_grad_norm=None, batch_size=10, episodes_before_train=0, use_cuda=False):
        self.env = env
